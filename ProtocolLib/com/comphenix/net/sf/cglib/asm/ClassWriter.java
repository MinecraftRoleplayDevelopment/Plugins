  ...
  implements ClassVisitor
{
  ...
  public byte[] toByteArray()
  {
    ...
    if (((this.j & 0x1000) != 0) && (((this.b & 0xFFFF) < 49) || ((this.j & 0x40000) != 0)))
    {
      i4++;
      i1 += 6;
      newUTF8("Synthetic");
    ...
    int i5 = 0x60000 | (this.j & 0x40000) / 64;
    localByteVector.putShort(this.j & (i5 ^ 0xFFFFFFFF)).putShort(this.k).putShort(this.m);
    localByteVector.putShort(this.n);
    for (int i6 = 0; i6 < this.n; i6++)
      localByteVector.putShort(this.o[i6]);
    ...
    if (this.q != null)
    {
      ...
      localByteVector.putByteArray(this.q.a, 2, i6);
    }
    if (this.r != 0)
    {
 ...
 * Qualified Name:     com.comphenix.net.sf.cglib.asm.ClassWriter
