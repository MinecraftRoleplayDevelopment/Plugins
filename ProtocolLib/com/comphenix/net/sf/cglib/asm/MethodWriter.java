  ...
  implements MethodVisitor
{
  ...
  public void visitMethodInsn(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    Item localItem = paramInt == 186 ? this.b.a(paramString2, paramString3) : this.b.a(paramString1, paramString2, paramString3, bool);
    int i1 = localItem.c;
    if (this.P != null)
      if (this.M == 0)
      {
  ...
  {
    int i1 = 0x60000 | (this.c & 0x40000) / 64;
    paramByteVector.putShort(this.c & (i1 ^ 0xFFFFFFFF)).putShort(this.d).putShort(this.e);
    if (this.h != 0)
    {
    ...
    if (this.r.b > 0)
    {
      ...
      paramByteVector.putShort(this.b.newUTF8("Code")).putInt(i3);
      ...
      if (this.v != null)
      {
        int i4 = (this.b.b & 0xFFFF) >= 50 ? 1 : 0;
        paramByteVector.putShort(this.b.newUTF8(i4 != 0 ? "StackMapTable" : "StackMap"));
    ...
    if (this.j > 0)
    {
      ...
      for (i3 = 0; i3 < this.j; i3++)
        paramByteVector.putShort(this.k[i3]);
    }
    if (((this.c & 0x1000) != 0) && (((this.b.b & 0xFFFF) < 49) || ((this.c & 0x40000) != 0)))
 ...
 * Qualified Name:     com.comphenix.net.sf.cglib.asm.MethodWriter
